...
public class SplError extends RuntimeException {
    ...
    public static SplError DoWhileConditionMustBeBoolean(Position position) {
        return new SplError(128, position, "'do while' test expression must be of type boolean");
    }
